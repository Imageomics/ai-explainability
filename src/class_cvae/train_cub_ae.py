...
def main(rank, world_size, args):
    ...
    trainer = AE_Trainer(ae, img_classifier, cub_z_from_label, gpu_id=rank, img_cls_resize_fn=normalize)
    trainer.train(train_dloader, test_dloader, epochs=args.epochs, lr=args.lr, logger=logger, \
                    ...
                    force_dis_lambda=args.force_dis_lambda, sparcity_lambda=args.sparcity_lambda, kl_lambda=args.kl_lambda)
